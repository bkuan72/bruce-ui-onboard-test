...
define(['require','exports','text!./app-test-menu.html','../../common/decorator/component','../../common/utils/MenuDataGenerator','../../common/utils/pubsub','../../common/utils/ko-utils','css!./app-test-menu.css'], function (require, exports, html, component_1, MenuDataGenerator_1, pubsub_1, ko_utils_1) {
    "use strict";
    ...
    var AppTestMenu = /** @class */ (function (_super) {
        ...
        AppTestMenu = __decorate([
            component_1.Component({ name: "app-test-menu", template: html })
        ], AppTestMenu);
        return AppTestMenu;
...
//# sourceMappingURL=app-test-menu.js.map
